...
*┃ ❍ ${ucapan()} ❍*
*╰━━━━━━━━━━━━━━━━╾•*
*_Toda la información que se mencione aquí no excluye al Propietario del Bot al uso de DorratBot_*
`.trim()
...
_- El chat anónimo del comando #start, valga la redundancia no mostrará ningún dato de los Usuarios por parte de DorratBot. Eso no implica que las personas que hagan uso de esta función puedan dar a conocer sus datos. en Número(s) Oficial(es)._
_- Los Datos que Obtenga DorratBot en Cuentas Oficiales de Usuarios(as), Grupos y Ajustes del Mismo puede verse Reiniciado, Modificado, y/o Retificado con el fin de que el Bot este en Óptimas Condiciones para su Uso. (Usuarios(as) Pueden Pedir Compensación Por Instagram o por el comando #Reporte. Debe de Presentar Pruebas)._
...
*https://github.com/GyutaroNc/DORRAT*
...
await conn.sendButtonVid(m.chat, pp, terminoA, terminoB, lenguajeGB.smsBotonM1(), '.menu', '🎧 ' + lenguajeGB.smsTex16() + ' 🎧', '/audios', lenguajeGB.smsBotonM3(), '#inventario', fkontak, adReply)
