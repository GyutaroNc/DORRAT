...
try {
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: texto, contextInfo: { externalAdReply: { title: '𝐃⃟𝕺𝐑⃯𝐑𝐇⃯𝚵𝐓᪣𝕭⃯𝚹⃯𝐓⃤', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/GyutaroNc/DORRAT' }, mentionedJid: [m.sender] }}}, { quoted: m })
...
conn.sendMessage(m.chat, { video: { url: data[data.length - 1] }, caption: '_𝐃⃟𝕺𝐑⃯𝐑𝐇⃯𝚵𝐓᪣𝕭⃯𝚹⃯𝐓⃤_', footer: await shortUrl(data[data.length - 1]), buttons }, { quoted: m })
} catch {
try {
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: texto, contextInfo: { externalAdReply: { title: '𝐃⃟𝕺𝐑⃯𝐑𝐇⃯𝚵𝐓᪣𝕭⃯𝚹⃯𝐓⃤', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/GyutaroNc/DORRAT' }, mentionedJid: [m.sender] }}}, { quoted: m })
