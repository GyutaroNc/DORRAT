...
{title: "⛔ | 𝙱𝙾𝚃 𝚃𝙴𝙼𝙿𝙾𝚁𝙰𝙻", description: "𝙰𝙲𝚃𝙸𝚅𝙰 𝙾 𝙳𝙴𝚂𝙰𝙲𝚃𝙸𝚅𝙰 𝚀𝚄𝙴 𝙴𝙻 𝙱𝙾𝚃 𝚂𝙴 𝚄𝙽𝙰 𝚃𝙴𝙼𝙿𝙾𝚁𝙰𝙻𝙼𝙴𝙽𝚃𝙴 𝙰 𝙶𝚁𝚄𝙿𝙾𝚂", rowId: `${usedPrefix + command} temporal`},
{title: "😃 | 𝚂𝙸𝙼𝙸", description: "𝙰𝙲𝚃𝙸𝚅𝙰 𝙾 𝙳𝙴𝚂𝙰𝙲𝚃𝙸𝚅𝙰 𝚀𝚄𝙴 𝙴𝙻 𝙱𝙾𝚃 𝙷𝙰𝙱𝙻𝙴 𝙴𝙽 𝙴𝙻 𝙲𝙷𝙰𝚃", rowId: `${usedPrefix + command} simi`},
...
text: ' ',
footer: `┏━━━━━━━━━━━━━┓
┣ ℹ️ _${usedPrefix}enable *welcome*_
┣ ℹ️ _${usedPrefix}disable *welcome*_
┣ ℹ️ _${usedPrefix}enable *public*_
┣ ℹ️ _${usedPrefix}disable *public*_
┣ ℹ️ _${usedPrefix}enable *modohorny*_
┣ ℹ️ _${usedPrefix}disable *modohorny*_
┣ ℹ️ _${usedPrefix}enable *antilink*_
┣ ℹ️ _${usedPrefix}disable *antilink*_
┣ ℹ️ _${usedPrefix}enable *antilink2*_
┣ ℹ️ _${usedPrefix}disable *antilink2*_
┣ ℹ️ _${usedPrefix}enable *detect*_
┣ ℹ️ _${usedPrefix}disable *detect*_
┣ ℹ️ _${usedPrefix}enable *restrict*_
┣ ℹ️ _${usedPrefix}disable *restrict*_
┣ ℹ️ _${usedPrefix}enable *pconly*_
┣ ℹ️ _${usedPrefix}disable *pconly*_
┣ ℹ️ _${usedPrefix}enable *gconly*_
┣ ℹ️ _${usedPrefix}disable *gconly*_
┣ ℹ️ _${usedPrefix}enable *autoread*_
┣ ℹ️ _${usedPrefix}disable *autoread*_
┣ ℹ️ _${usedPrefix}enable *temporal*_
┣ ℹ️ _${usedPrefix}disable *temporal*
┣ ℹ️ _${usedPrefix}enable *simi*_
┣ ℹ️ _${usedPrefix}disable *Simi*_
┣ ℹ️ _${usedPrefix}enable *audios*_
┣ ℹ️ _${usedPrefix}disable *audios*_
┣ ℹ️ _${usedPrefix}enable *antiviewonce*_
┣ ℹ️ _${usedPrefix}disable *antiviewonce*_
┣ ℹ️ _${usedPrefix}enable *autosticker*_
┣ ℹ️ _${usedPrefix}disable *autosticker*_
┣ ℹ️ _${usedPrefix}enable *anticall*_
┣ ℹ️ _${usedPrefix}disable *anticall*_
┣ ℹ️ _${usedPrefix}enable *antiprivado*_
┣ ℹ️ _${usedPrefix}disable *antiprivado*_
┣ ℹ️ _${usedPrefix}enable *antitoxic*_
┣ ℹ️ _${usedPrefix}disable *antitoxic*_
┣ ℹ️ _${usedPrefix}enable *antitraba*_
┣ ℹ️ _${usedPrefix}disable *antitraba*_
┣ ℹ️ _${usedPrefix}enable *antiarabes*_
┣ ℹ️ _${usedPrefix}disable *antiarabes*_
┣ ℹ️ _${usedPrefix}enable *modejadibot*_
┣ ℹ️ _${usedPrefix}disable *modejadibot*_
┣ ℹ️ _${usedPrefix}enable *modoadmin*_
┣ ℹ️ _${usedPrefix}disable *modoadmin*_
┗━━━━━━━━━━━━━┛`,
title: null,
...
🛡️ 𝐏𝐀𝐑𝐀: ${isAll ? '𝙴𝚂𝚃𝙴 𝙱𝙾𝚃' : isUser ? '' : '𝙴𝚂𝚃𝙴 𝙲𝙷𝙰𝚃'}`, author, null, [[`${isEnable ? '❎ 𝙳𝙴𝚂𝙰𝙲𝚃𝙸𝚅𝙰𝚁 ❎' : '☑️ 𝙰𝙲𝚃𝙸𝚅𝙰𝚁 ☑️'}`, `${isEnable ? `#disable ${type}` : `#enable ${type}`}`], ['🌠 𝙼𝙴𝙽𝚄 𝙿𝚁𝙸𝙽𝙲𝙸𝙿𝙰𝙻 ', '#menu']], m)}
